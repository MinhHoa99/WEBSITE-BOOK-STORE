...
namespace WebsiteBanSach.Controllers
{
    public class DanhMucsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            List<Sach> list = db.Saches.Where(x => x.MaDanhMuc == id).ToList();
            if (danhMuc == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult TacGia(int? id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
            Sach danhMuc = db.Saches.Find(id);
            List<Sach> list = db.Saches.Where(x => x.MaSach == id).ToList();
            if (danhMuc == null)
            {
                return HttpNotFound();
            }
